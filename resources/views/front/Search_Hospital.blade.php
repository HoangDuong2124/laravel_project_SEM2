      ...
      <div class="main-content">
                ...
                <div class="search-box">
                   ...
                   <div class="search-input">
                     <div>
                      ...
                      <input type="text" id="keyword_search" name="keyword_search" class="text-search" placeholder="Tìm triệu chứng, chuyên khoa, tên bệnh viện, phòng khám">
                   </div>
       ...
       <div class="btn-content-hospital">
          <div class="btn-content-hospital-title">
             <div>Chọn cơ sở y tế</div>
          </div>
            <div class="container">  
           <div class="row">
             @foreach($cate_hospital as $key =>$cate)
           <div class="col-lg-4 col-xs-4" style="padding-left: 15px; padding-right: 15px;">
             ...
             <div class="content-hospital">
                <a style="text-decoration:none;" href="{{URL::to('/ho-so-csyt/'.$cate->hospital_code)}}"><h3 class="text-hospital">{{$cate->name_hospital}}</h3></a>
