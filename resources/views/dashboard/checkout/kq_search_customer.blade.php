  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
           @foreach($search_customer as $key => $cate)
          <tr>
            ...
            <td style="text-align: center;width: 125px;;"><p class="customer_status">{{$cate->customer_status}}</p></td>
            <td >{{$cate->created_at}}</td>
            <td style="text-align: center;"><a href="{{URL::to('/show-book')}}">Chi tiết</a></td>
